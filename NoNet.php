                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    Pinza izquierda Dr. Fernando P.E
                                    </div>
                                    <div class="card-body">
                                    <canvas id="myChart1"></canvas>
                                    <script src="js/scripts.js"></script>
                                    <script>
                                        create_chartRight("data/Datos_Sutura/Dr. Fernando P.E_2023-05-22_14-42-50.csv", "myChart1");
                                    </script>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-4">
                                    <div class="card-header">
                                    <i class="fas fa-chart-line me-1"></i>
                                    Pinza Derecha Dr. Fernando P.E
                                    </div>
                                    <div class="card-body">
                                    <canvas id="myChart2"></canvas>
                                    <script src="js/scripts.js"></script>
                                    <script>
                                        create_chartLeft("data/Datos_Sutura/Dr. Fernando P.E_2023-05-22_14-42-50.csv", "myChart2");
                                    </script>
                                    </div>
                                </div>
                            </div>
